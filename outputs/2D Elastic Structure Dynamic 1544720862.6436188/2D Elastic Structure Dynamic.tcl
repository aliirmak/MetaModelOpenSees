...
#--------
# Define rayleigh damping - for transient analysis
set freq [expr [eigen 1]**0.5]
rayleigh [expr 2*$damp*$freq] [expr 0] [expr 0] [expr 0]; # set damping based on first eigen mode
...
loadConst -time 0.0; # set gravity loads constant and time in domain to t = 0.0

timeSeries Path 2 -dt 0.01 -filePath C:\\mywebgmeapp\\OpenSees\\TakY.th -factor [expr 0.50*$g]; # define acceleration vector from file (dt=0.01 is associated with the input file gm)
